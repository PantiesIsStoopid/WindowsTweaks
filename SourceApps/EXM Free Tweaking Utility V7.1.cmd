@echo off
::Exm free tweaking utility v7.1 | Made and distributed by EXM TWEAKS, S.R.O. ® 2024
...
echo. 
echo. 
echo.                                                                                                  %W% EXM FREE TWEAKING UTILITY VERSION 7.1                        
echo.
echo.                                                                                    %p% ██╗       ██╗███████╗██╗      █████╗  █████╗ ███╗   ███╗███████╗ 
echo.                                                                                    %p% ██║  ██╗  ██║██╔════╝██║     ██╔══██╗██╔══██╗████╗ ████║██╔════╝ 
echo.                                                                                    %p% ╚██╗████╗██╔╝█████╗  ██║     ██║  ╚═╝██║  ██║██╔████╔██║█████╗   
...
echo.  
echo.                                                                        Made and distributed by EXM TWEAKS, S.R.O. ® 2024 * Version 7.1 * Updated 17t of december
echo.                                          %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                               
echo.
echo.
...
echo.                                                                                                                                                                                 
echo.                                                            %p%[%w%4%p%]%w% PC clean                           %p%[%w%5%p%]%w% Memory Optimizations                  %p%[%w%6%p%]%w% Disable Startup Services             
echo.                                                                                                                                                                                 
echo.                                                            %p%[%w%7%p%]%w% GPU Optimizations                  %p%[%w%8%p%]%w% CPU Optimizations                     %p%[%w%9%p%]%w% USB Optimizations                    
echo.                                                                                                                                                                                 
echo.                                                            %p%[%w%10%p%]%w% Power Optimization                %p%[%w%11%p%]%w% System Debloat                       %p%[%w%12%p%]%w% Storage Optimizations                
echo.                                                                                                                                                                                 
echo.                                                            %p%[%w%13%p%]%w% Fix Corrupted Files               %p%[%w%14%p%]%w% Set Full Screen Optimization         %p%[%w%15%p%]%w% Uninstall Useless Apps               
echo.                                                                                                                                                                                 
echo.                                                            %p%[%w%16%p%]%w% Disable Useless Animations        %p%[%w%17%p%]%w% Windows Update Blocker               %p%[%w%18%p%]%w% EXM Network Tweaking Utility        
echo.                                                                                                                                                                                 
echo.                                             %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
echo.                                                                                                                                                                                 
...
echo.                                                                                                                                                                                   
echo.                                                                                                                                                                                  
echo.                                                                  %w%  Made and distributed by EXM TWEAKS, S.R.O. ® 2024 * Version 7.1 * Updated 17th of December 2024                   
echo.                                                                                                                                                                                 
echo.                                             %b%"════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w%
...
echo.                                                                                                                      
echo.                                                                       %p%[%w%3%p%]%w% Revert Windows Category                                         
echo.                                                                                                                      
...
echo.
echo.                                                                       %p%[%w%11%p%]%w% Revert Network Utility (options 1-8)
echo.
echo.
echo.                                                                                                                       
...
echo.                                                        %b%"═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w% 
echo.                                                                                                                                                                                               
echo.                                                                           %p%%w%%p%%w%                                 %p%[%w%T%p%]%w% Watch the tutorial (Skip to 2:15)                                  
echo.                                                                                                                                                                                              
echo.                                                                           %p%%w%%p%%w%                                  %p%[%w%A%p%]%w% Apply all (1-9)                                                      
echo.                                                                                                                                                                                              
...
echo.                                                                                                                                                                                                 
echo.                                                                           %p%[%w%7%p%]%w% Disable Teredo Tunneling                    %p%[%w%8%p%]%w% Disable NETBIOS Over TCPIP                                
echo.                                                                                                                                                                                  
echo.                                                                           %p%[%w%9%p%]%w% Optimize Lanman Server                      %p%[%w%10%p%]%w% Optimize NIC Adapter Settings                            
echo.                                                                                                                                                                                               
echo.                                                                           %p%[%w%11%p%]%w% Set a QOS Policy                           %p%[%w%12%p%]%w% Open NIC Settings                                         
echo.                                                                                                                                                                                              
echo.                                                        %b%"═════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w% 
echo.                                                                                                                                                                                               
echo.                                                                          %p%[%w%R%p%]%w% Revert (1-9)                                %p%[%w%X%p%]%w%  Go Back To Menu                    
echo.                                                                                                                                                                                                 
echo.                                                                   %w%  Made and distributed by EXM TWEAKS, S.R.O. ® 2024 * Version 1.3 * Updated 17th of December 2024                  
echo.                                                                                                                                                                                                  
echo.                                                        %b%"══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"%w% 
echo.                                                                 
echo.
...
echo.                                                                                                                      
echo.                                                             %p%[%w%1%p%]%w% Disable Notifications       %p%[%w%2%p%]%w% Optimize Windows Search           
echo.                                                                                                                                
echo.                                                             %p%[%w%3%p%]%w% Disable Bluetooth           %p%[%w%4%p%]%w% Disable Transparency    
echo.                                                                                                                                                                                                                 
echo.                                                             %p%[%w%5%p%]%w% Disable Error Reporting     %p%[%w%6%p%]%w% Disable Setting Synchronization            
echo.                                                                                                                                
echo.                                                             %p%[%w%7%p%]%w% Disable Diagnostics         %p%[%w%8%p%]%w% Disable Background Apps        
echo.
echo.                                                             %p%[%w%9%p%]%w% Disable Experiments         %p%[%w%10%p%]%w% Toggle Game Mode       
echo. 
echo.                                                             %p%[%w%11%p%]%w% Disable Maintenece         %p%[%w%12%p%]%w% Disable Tracking and some diagnostics                            
echo. 
echo.                                                             %p%[%w%13%p%]%w% Disable Popups + more      %p%[%w%14%p%]%w% Disable Activity feed    
echo. 
echo.                                                             %p%[%w%15%p%]%w% Disable Smart Screen       %p%[%w%16%p%]%w% Stop Reinstalling Preinstalled apps 
echo.
echo.                                                             %p%[%w%17%p%]%w% Disable Shared Experiences %p%[%w%18%p%]%w% Track Only Important Failure Events  
echo. 
echo.
echo.                                                             %p%%p%%p%%p%                     %p%[%w%M%p%]%w% Back to menu                                          
echo.     
...
echo.                                                                                                                               
echo.                                                               %p%[%w%13%p%]%w% Microsoft Store          %p%[%w%14%p%]%w% Disable Windows Insider 
echo.
echo.                                                                                                                                                    
echo.                                                                                      %p%[%w%M%p%]%w% Back to menu   
echo. 
...
echo.                                            %p% ╚═════╝ ╚═╝     ╚═════╝ ╚═╝  ╚═╝   ╚═╝   ╚══════╝  ╚═════╝ ╚══════╝ ╚════╝  ╚════╝ ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝
chcp 437 >nul 2>&1
powershell "&  {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('You have to enable updates in windows update blocker in order to use microsoft store, simply press "ok" to open Windows Update Blocker. ', 'Exm Tweaking Utility', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
echo. 
echo.                                                                  %p%[%w%6%p%]%w% Optimize Performance Time Check Interval   
echo.
echo.      
echo.                                                                            %p%[%w%M%p%]%w% Back to menu   
echo. 
